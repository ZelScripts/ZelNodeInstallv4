...
```
wget https://raw.githubusercontent.com/ZelScripts/ZelNodeInstallv4/master/zelnodev4.sh && chmod +x zelnodev4.sh && ./zelnodev4.sh
```
...
***
**Managing daemon service**  
To start service ===>    **systemctl start zelcash.service**  
To stop service  ===>    **systemctl stop zelcash.service**  
To check status  ===>    **systemctl status zelcash.service**
***
**Updating binaries**  
When it is officially announced that APT repo is updated with new binaries run following command to update.  
To update  ===>    **./zelnodeupdate.sh**
***
Many thanks to **AltTank fam**, **dk808**, **Skyslayer**, **Goose-Tech**, & **Packetflow** for their contributions to this script, and the **ZelCash Team** for debugging and assistance.
